...
export default function EditProfileScreen() {
  ...
  const [username, setUsername] = useState('David'); // Example placeholder
  const [password, setPassword] = useState('********'); // Example placeholder

  // Placeholder user data for display (can be fetched or passed)
  const userNameDisplay = "David"; // Example user name for display
  ...
  const handleSavePress = () => {
    ...
    console.log("Updated Data:", { number, username, password });
        ...
        router.replace('/PagesUser'); // Navigate to the index file (Home)
