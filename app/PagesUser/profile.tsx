...
export default function ProfileScreen() {
  ...
  const handleChangePasswordPress = () => {
    ...
    router.push('/PagesUser/edit-profile'); // Navigate to the new editProfile.tsx
  };
  ...
  const handleMyLaundryPress = () => {
    ...
    // Use replace to navigate to the My Laundry screen and clear history
    router.replace('/PagesUser/myLaundry');
  };
  ...
  return (
    <SafeAreaView style={styles.safeAreaContainer}> {/* Wrap in SafeAreaView */}
      ...
      <View style={styles.header}>
        <View style={{ width: 24 }} /> {/* Placeholder for potential back button alignment */}
        <Text style={styles.headerTitle}>Settings</Text>
        <View style={{ width: 24 }} /> {/* Placeholder for potential right icon alignment */}
      </View>
      ...
      <ScrollView style={styles.mainContent} contentContainerStyle={styles.mainContentPadding}>
        ...
        <View style={styles.optionsContainer}>
          ...
          <TouchableOpacity style={styles.optionRow} onPress={handleChangePasswordPress}>
      ...
      <View style={styles.bottomNavBar}>
         ...
         {/* Middle Icon (My Laundry) - Inactive */}
